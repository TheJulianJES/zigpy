...
-- OTA provider index cache: stores trusted providers' image metadata
DROP TABLE IF EXISTS ota_provider_index_cache_v16;
CREATE TABLE ota_provider_index_cache_v16 (
    provider_id TEXT NOT NULL,
    last_updated REAL NOT NULL,
    index_json TEXT NOT NULL
);

CREATE UNIQUE INDEX ota_provider_index_cache_idx_v16
    ON ota_provider_index_cache_v16(provider_id);
